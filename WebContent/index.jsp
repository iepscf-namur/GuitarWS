...
<body>
    ...
    <p>/users <a href="/users">Search all users and return a Json array string</a></p>
    <p>/users/login <a href="/users/login-name">Search all users corresponding to login and return a Json array string</a></p>
	<h3>POST</h3>
	...
	<h3>DELETE</h3>
    <p>/users/login <a href="/users/login-name">Deletes the requested user</a></p>
	<h3>PUT</h3>
    <p>/users/login <a href="/users/login-name">Update the role specified, requires a JSON body like POST</a></p>
